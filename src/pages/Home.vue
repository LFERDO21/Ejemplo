<template>
  <div id="home">
    ...
    <div class="lg:flex justify-between items-center mb-6">
      <p class="text-2xl font-semibold mb-2 lg:mb-0">Hola Dr Jose</p>
      <button
    ...
    <div class="flex flex-wrap -mx-3 mb-20">
      ...
      <div class="w-1/2 xl:w-1/4 px-3">
        ...
        >
          ...
          <div class="text-gray-700">
            <p class="font-semibold text-3xl">52</p>
            <p>Comentarios</p>
          </div>
        </div>
      </div>
    ...
    <div class="flex flex-wrap -mx-3">
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">Interacciones</p>
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">Generos</p>
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">Usuarios completados</p>
        <div class="w-full bg-white border rounded-lg p-4">
          <div
            class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4"
          >
            <div>
              <p class="font-semibold text-xl">M. Belen</p>
              <p>Encuesta PSK</p>
            </div>
            <span class="text-green-500 font-semibold text-lg">Completado</span>
          </div>
          ...
          >
            <div>
              <p class="font-semibold text-xl">M. Fernanda</p>
              <p>Encuesta Estilo de Aprendizaje</p>
            </div>
            <span class="text-red-500 font-semibold text-lg">Incompleto</span>
          </div>
          ...
          >
            <div>
              <p class="font-semibold text-xl">L. Fernando</p>
              <p>Encuesta Aprendizaje de Preferencia</p>
            </div>
            <span class="text-green-500 font-semibold text-lg">Completado</span>
          </div>
          ...
          >
            <div>
              ...
              <p>Encuesta prendizaje de Preferencia</p>
            </div>
            <span class="text-green-500 font-semibold text-lg">Completado</span>
          </div>
        </div>
          ...
          datasets: [
            {
              ...
              pointColor: "#fff",
              pointStrokeColor: "#63b3ed",
              data: [25, 18, 22, 20, 20, 20, 20],
            },
            {
              backgroundColor: "rgba(249,179,237,0.4)",
              strokeColor: "#63b3ed",
              pointColor: "#fff",
              pointStrokeColor: "#63b3ed",
              data: [24, 20, 25, 15, 17, 16, 22],
            },
          ],
        },
        options: {
